...
/*O código está juntando as duas tabelas, User e Order, mostrando todas as colunas específicas, e filtrando onde o user_id tenha (1,3,5),
 como não existe orders para o usuário 3, não entrou dentro do select 
*/
